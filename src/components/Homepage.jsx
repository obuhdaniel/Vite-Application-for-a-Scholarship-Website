    ...
    <>
      ...
      <div>
          ...
          <div className="hero">
            <div className="hero-texts">
              <h1 className="hero-text-1">
                Unlock Your Future: The Algorithm National Scholarship
                Examination
              </h1>
        ...
        <section className="competition-info">
          <div className="info-container">
            <h2 className="info-title">
              Join the Algorithm National Competition
            </h2>
            <p className="info-description">
              Interested aspirants are invited to become a part of the ALGORITHM
              NATIONAL COMPETITION. The selected students will receive an award
              amount of <strong>₦50,000</strong> each.
            </p>
            ...
            <div className="brief-description">
              ...
              <ul>
                <li>
                  <strong>Organization:</strong> SMATLAB360
                </li>
                <li>
                ...
                <li>
                  <strong>Access Mode:</strong> Online
                </li>
                <li>
                  <strong>Number of Awards:</strong> N/A
                </li>
                <li>
        ...
        <div className="newsletter-signup">
          <h2 className="subscribe_text">Subscribe to our Newsletter</h2>
